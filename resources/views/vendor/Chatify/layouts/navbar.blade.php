    ...
    <footer class="footer-container">
        ...
        <div class="footer-item">
            <a href="/chatterfly" class="{{ request()->is('chatterfly') ? 'text-teal' : 'text-inactive' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="footer-icon" viewBox="0 0 24 24">
                    ...
                    <path d="M18 3a4 4 0 0 1 4 4v8a4 4 0 0 1 -4 4h-4.724l-4.762 2.857a1 1 0 0 1 -1.508 -.743v-2h-1a4 4 0 0 1 -4 -4v-8a4 4 0 0 1 4 -4z" />
                </svg>
            </a>
            <span class="{{ request()->is('chatterfly') ? 'text-teal' : 'text-inactive' }}">Chat</span>
        </div>
        ...
        <div class="footer-item">
            <a href="/profile" class="{{ request()->is('profile') ? 'text-active' : 'text-inactive' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="footer-icon" viewBox="0 0 24 24">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M19 3a3 3 0 0 1 3 3v12a3 3 0 0 1 -3 3h-14a3 3 0 0 1 -3 -3v-12a3 3 0 0 1 3 -3h14zm-2 12h-10a1 1 0 0 0 0 2h10a1 1 0 0 0 0 -2zm0 -4h-10a1 1 0 0 0 0 2h10a1 1 0 0 0 0 -2zm0 -4h-10a1 1 0 0 0 0 2h10a1 1 0 0 0 0 -2z" />
                </svg>
            </a>
        ...
        <!-- Group -->
        <div class="footer-item">
            <a href="/chatterfly" class="{{ request()->is('') ? 'text-active' : 'text-inactive' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="footer-icon" viewBox="0 0 24 24">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div class="footer-item">
            <a href="/bio" class="{{ request()->is('bio') ? 'text-active' : 'text-inactive' }}">
                <img src="{{ asset('storage/users-avatar/' . Auth::user()->avatar) }}" alt="User Avatar" class="user-avatar" />
            </a>
            <span class="{{ request()->is('bio') ? 'text-active' : 'text-inactive' }}" style="margin-top: 4px;">Bio</span>
        </div>
    </footer>
</div>
