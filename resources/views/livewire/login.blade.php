    ...
    <section class="vh-100 bg-white mb-2"
        ...
        <div class="container py-1 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-12 col-md-8 col-lg-6 col-xl-4" style="padding-bottom:30px;">
                    <div class="card text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center" style="color: black;">
                            <div class="mb-md-5 mt-md-4 pb-2">
                                <h2 class="fw-bold mb-4 text-center" style="font-size: 16px;">Selamat Datang</h2>
                                <form wire:submit.prevent="login">
                                    ...
                                    <div class="position-relative">
                                        <input type="password" wire:model="password" id="typePasswordX"
                                            class="form-control form-control-lg pr-5" placeholder="Password" required style="font-size:14px;" />
                                    ...
                                    <p class="d-flex justify-content-end mt-0 mb-3" style="font-size:13px;"
                                ...
                                <div class="d-flex justify-content-center text-center mt-2 pt-1">
                                    <a href="https://www.facebook.com/?locale=id_ID" class="text-black"><i class="fab fa-facebook-f fa-lg"></i></a>
                            ...
                            <div>
                                <p class="mb-0">Belum Punya Akun?
                                    <a href="registrasi" class="text-white-50 fw-bold" style="text-decoration: underline">Sign Up</a>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div wire:ignore.self class="modal fade" id="changepassword" tabindex="-1" aria-labelledby="exampleModalLabel"
           ...
           margin-right: 10px;">
                        ...
                        <button class="btn" wire:click="sendResetLink"
                            style="background: linear-gradient(to right, rgba(68, 173, 159, 0.9), rgba(68, 173, 159, 0.7), rgba(68, 173, 159, 0.3)); 
                           color: white; border: none; padding: 10px 50px; border-radius: 8px; font-weight: bold;" class="wh-100">
                            Kirim
                        </button>
                    </div>
                </div>
